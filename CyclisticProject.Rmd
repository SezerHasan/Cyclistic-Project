...
ii. Subscribers prefer bikes on weekends less. Thus, one campaign might be to offer free/discounted rates on weekday use for customers if they prefer bikes on the weekends. This may help with the engagement of them all week and becoming a customer. The campaign might goes as: "Ride three weekdays, get one weekend deal, and ride five weekdays and get two weekend deal." 
